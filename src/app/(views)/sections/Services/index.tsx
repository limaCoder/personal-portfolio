...
export function ServicesSection() {
  return (
    <section
      id="services"
      className="bg-gradient_dark min-h-screen xl:min-h-[60vh] w-full relative py-20"
    >
              ...
              >
                <AccordionItem className="border-0" value="item-1">
                  <AccordionTrigger className="relative flex flex-row gap-4 after:content-normal after:absolute after:bottom-0 after:w-14 after:h-[2px] after:rounded-lg after:bg-custom_secondary">
                    ...
                    <h3 className="font-headline_four text-custom_white-light">
                      Web Development
                    </h3>
                  </AccordionTrigger>
                ...
                <AccordionItem className="border-0" value="item-2">
                  <AccordionTrigger className="relative flex flex-row gap-4 after:content-normal after:absolute after:bottom-0 after:w-14 after:h-[2px] after:rounded-lg after:bg-custom_secondary">
                    ...
                    />
                    <h3 className="font-headline_four text-custom_white-light text-center sm:text-start">
                      Mobile Development
                    </h3>
                  </AccordionTrigger>
                  <AccordionContent className="font-body_two text-custom_white-dark pt-6">
