        ...
        >
          <AccordionTrigger className="w-full">
            <div className="flex flex-col gap-2 items-start text-sm sm:text-base">
              <h3 className="font-headline_four text-custom_white-dark text-left">
                @ {workExperience?.companyName}
              </h3>
              <h4 className="font-headline_four text-custom_white-light text-left">
                {workExperience?.role}
              </h4>
              <span className="font-body_one text-custom_white-dark text-left">
